...
1. **Which product categories have the highest sales?**
   - **Answer**: 
    - **Top 5 Product Categories by Sales**:
         ...
         - Watches & Gifts: $1,165,898.98 
         - Bed, Bath & Table: $1,023,434.76 
         - Sports & Leisure: $954,673.55 
         - Computers & Accessories: $888,613.62 
...
3. **Which states have the highest number of orders?**
   - **Answer**: 
    - **Top 5 States by Order Volume**:
         - São Paulo(SP): 40,494 orders 
         - Rio de Janeiro(RJ): 12,350 orders 
         - Minas Gerais(MG): 11,354 orders
         - Rio Grande do Sul(RS): 5,344 orders 
         - Paraná(PR): 4,923 orders
